...
def text_to_ids(source_text, target_text, source_vocab_to_int, target_vocab_to_int):
    ...
    source_id_text = [[source_vocab_to_int.get(word, source_vocab_to_int['<UNK>'])for word in sentence.split(' ')] for sentence in source_sentences]
    target_id_text = [[target_vocab_to_int.get(word, target_vocab_to_int['<UNK>'])for word in sentence.split(' ')]+[target_vocab_to_int['<EOS>']] for sentence in target_sentences]
...
def seq2seq_model(input_data, target_data, keep_prob, batch_size,
    ...
    train_dec_output, infer_dec_output = decoding_layer(dec_input, encoder_state,target_sequence_length,                                                         max_target_sentence_length, rnn_size, num_layers,                                                         target_vocab_to_int, target_vocab_size,                                                         batch_size, keep_prob, dec_embedding_size)
